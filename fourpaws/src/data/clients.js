...
export const DEMO_MESSAGES = [
  { id: 'msg-1', clientId: 'client-1', from: 'client', text: 'Hi! Just completed module 1 and Caspian is doing amazingly well with the bonding exercises. The trust building rituals have transformed our morning routine!', timestamp: '2024-03-20T10:30:00', read: true },
  { id: 'msg-2', clientId: 'client-1', from: 'admin', text: 'That\'s wonderful to hear, Victoria! Caspian sounds like a natural. I\'d love to hear more about which specific rituals resonated most — it really helps us tailor Module 2 for him.', timestamp: '2024-03-20T11:15:00', read: true },
  { id: 'msg-3', clientId: 'client-1', from: 'client', text: 'The morning connection ritual has been incredible. He now waits calmly at the door every single morning. It feels like we have a whole new relationship.', timestamp: '2024-03-20T14:20:00', read: false },
  { id: 'msg-4', clientId: 'client-2', from: 'client', text: 'The reactivity programme is changing everything. We had our first calm walk past another dog yesterday. I actually cried.', timestamp: '2024-03-21T09:00:00', read: true },
  { id: 'msg-5', clientId: 'client-2', from: 'admin', text: 'Sebastian, this is such a significant milestone. That calm walk represents months of nervous system healing for Duchess. You should be incredibly proud of both of you.', timestamp: '2024-03-21T09:45:00', read: true },
...
export const ADMIN_USER = {
  id: 'admin-1',
  name: 'The Academy',
  email: 'admin@fourpawsacademy.com',
  password: 'admin2024',
  role: 'admin',
}
